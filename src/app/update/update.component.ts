...
export class UpdateComponent implements OnInit {
  ...
  AddProduct()
  {
    ...
    var admindto={
      ...
      productMrp:Number(this.adminprod.productprice),
      productDiscount:Number(this.adminprod.productDiscount),
      productSellingPrice:Number(this.adminprod.productSellingPrice),

    }
    this.httpc.put("https://localhost:44338/api/Product",admindto).subscribe(res=>this.PostSuccess(res),res=>this.PostError(res));
